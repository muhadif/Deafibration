package id.infiniteuny.deafibration.utils.audio.core;
...
public class AudioRecorder {
    ...
    public AudioRecorder(AudioCallback callback) {
        ...
        thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (recorder.getState() == AudioRecord.STATE_UNINITIALIZED) {
                    ...
                    Log.i(AudioRecorder.class.getSimpleName(), "Started.");
                    //callback.onStart();
                }
